...
-- AddForeignKey
ALTER TABLE `Pinjam`
    ADD CONSTRAINT `Pinjam_memberId_fkey` FOREIGN KEY (`memberId`) REFERENCES `Members` (`id`) ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `Pinjam`
    ADD CONSTRAINT `Pinjam_bookId_fkey` FOREIGN KEY (`bookId`) REFERENCES `Books` (`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
